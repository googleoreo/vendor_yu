...
PRODUCT_COPY_FILES += \
    ...
    vendor/yu/jalebi/proprietary/lib/libmm-qcamera.so:system/lib/libmm-qcamera.so \
    vendor/yu/jalebi/proprietary/lib/libmmcamera_interface.so:system/lib/libmmcamera_interface.so \
    vendor/yu/jalebi/proprietary/lib/libmmjpeg_interface.so:system/lib/libmmjpeg_interface.so \
    vendor/yu/jalebi/proprietary/lib/libOmxVdecHevc.so:system/lib/libOmxVdecHevc.so \
    vendor/yu/jalebi/proprietary/lib/libqomx_core.so:system/lib/libqomx_core.so \
    vendor/yu/jalebi/proprietary/lib/hw/camera.msm8916.so:system/lib/hw/camera.msm8916.so \
    vendor/yu/jalebi/proprietary/lib/hw/lights.msm8916.so:system/lib/hw/lights.msm8916.so \
